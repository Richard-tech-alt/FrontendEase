...
export default function App() {
  ...
  const handleSignup = (e) => {
    ...
    // Fake signup logic (you would replace this with your API call)
    setTimeout(() => {
      setStatus("Signup successful! Sending TrustWallet review invitation...");

      // Trustpilot invitation object
      const invitation = {
        recipientEmail: formData.email,
        recipientName: formData.name,
        referenceId: `signup_${Date.now()}`,
        source: "InvitationScript",
        products: [
          {
            sku: "trustwallet_card",
            productUrl: "https://easewithdraw.com/trustwallet",
            imageUrl:
              "https://easewithdraw.com/trustwalletcard-removebg-preview.png",
            name: "TrustWallet Card"
          }
        ]
      };

      // Call Trustpilot invitation method
      if (typeof tp === "function") {
        tp("createInvitation", invitation);
        setStatus("Invitation sent! Please check your email.");
      } else {
        setStatus("Trustpilot script not loaded.");
      }
    }, 1000);
  };
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "400px", margin: "auto" }}>
      <h2>Signup to Review TrustWallet</h2>
