...
// // import BinanceCardSelection from './BinanceCardSelection';
...
// //                     className="bg-pink-700 text-white font-bold px-6 md:px-8 py-2 md:py-3 rounded-full text-sm md:text-base hover:bg-pink-800 transition-colors duration-300 w-full xs:w-auto flex justify-center"
// //                   >
// //                     Get your card
// //                   </button>
...
// //             <button 
// //               onClick={closeModal}
// //               className="fixed top-4 right-4 z-60 w-10 h-10 bg-white/90 hover:bg-white rounded-full flex items-center justify-center shadow-lg transition-colors"
// //             >
// //               <X className="w-5 h-5" />
// //             </button>
            
// //             {/* Card Selection Component */}
// //             <BinanceCardSelection onClose={closeModal} />
// //           </div>
// //         </div>
// //       )}
// //     </div>          
...
//       {/* Modal - Fixed positioning and z-index issues */}
//       {showCardSelection && (
...
//             <button 
//               onClick={closeModal}
//               className="absolute top-4 right-4 z-[10000] w-10 h-10 bg-white/90 hover:bg-white rounded-full flex items-center justify-center shadow-lg transition-colors"
//             >
//               <X className="w-5 h-5" />
//             </button>
...
const CryptoCardComponent = () => {
  ...
  const cardData = {
    virtual: {
      title: "VIRTUAL CRYPTO CARD",
      subtitle: "ANYTIME, ANYWHERE",
      features: ["Instant transaction", "Widely-accepted", "Compatible with Apple Pay/Google Pay"],
    },
    physical: {
      title: "PHYSICAL CRYPTO CARD",
      subtitle: "ONE CARD FOR ALL",
      features: ["Tap and Pay", "ATM withdrawal"],
      primaryImage: { card1 },
      secondaryImage: { card2 },
    },
  }
          ...
          >
            <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8 lg:pr-12 lg:pt-20 md:pt-10 sm:pt-10 md:mt-10">
              ...
              <div className="flex flex-col xs:flex-row justify-start items-start xs:items-center gap-4 sm:gap-6 md:gap-10 mb-6 md:mb-12">
                ...
                <div className="flex gap-4 sm:gap-8 items-center mt-2 xs:mt-0">
                  <img src={GooglePlay || "/placeholder.svg"} alt="Google Play" className="h-5 sm:h-6 md:h-8" />
                  <img src={ApplePlay || "/placeholder.svg"} alt="Apple Pay" className="h-5 sm:h-6 md:h-8" />
                </div>
              </div>
            </div>
