...
//               >
//                 <div className="w-32 h-20 sm:w-40 sm:h-22 md:w-48 md:h-32 lg:w-60 lg:h-36 rounded-2xl overflow-hidden transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
...
const OurMainCardsMarquee = () => {
  ...
  return (
    <section className="marquee-section h-auto bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden py-16">
      <div className="container mx-auto w-full">
        <div className="text-center mb-12 w-full">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 leading-tight mt-10">
            Your Go-To Collection Of The Most Popular Digital Cards
          ...
          <div className="flex animate-marquee">
            {duplicatedImages.map((image, index) => (
              <div
                ...
                className="flex-none mx-2 sm:mx-3 md:mx-4"
              >
                <div className="marquee-card w-32 h-20 sm:w-40 sm:h-22 md:w-48 md:h-32 lg:w-60 lg:h-36 rounded-2xl overflow-hidden transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
                  <div className="w-full h-full relative group">
                    <img
                      src={image.src}
                      alt={image.alt}
      ...
      <style>{`
        ...
        .marquee-section .animate-marquee:hover {
          animation-play-state: paused;
        }
        ...
        /* Apply smooth scrolling only to marquee elements */
        .marquee-section .marquee-card {
          -webkit-transform: translateZ(0);
          transform: translateZ(0);
        }
