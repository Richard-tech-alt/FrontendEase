...
const originalCards = [
  ...
  },
  {
    title: "TRANSFER",
    description:
      "Effortlessly transfer Fiat with EaseWithDraw crypto, bridging traditional finance and crypto payment solutions (Coming soon)",
    image: carousal4,
...
export default function EaseWithDrawScroller() {
  ...
  return (
    <div className="w-full h-auto py-20 bg-white">
      ...
      <h2 className="text-4xl  md:text-4xl sm:text-lg font-bold text-center  mt-10 mb-10 lg:mb-20 text-pink-500">
      ...
      <div className="flex justify-center">
        <div
          ref={containerRef}
          className="flex overflow-x-auto no-scrollbar gap-8 scroll-smooth w-full max-w-[800px] px-4 py-6 snap-x snap-mandatory"
        >
