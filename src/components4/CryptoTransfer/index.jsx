...
const CryptoToFiatBanner = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-0 right-0 w-full lg:w-3/4 h-3/4 op0 bg-repeat space-y-2  z-0"
        style={{
      ...
      >
        <div className="relative">
          <img
            src={transfer}
            alt="Transfer"
            className="w-full  max-w-xs sm:max-w-sm md:max-w-md mx-auto  rounded-3xl shadow-lg"
          />
