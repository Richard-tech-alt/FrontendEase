...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! With Ease Withdraw, you can buy, manage, and use multiple digital cards—such as Cash App, Coinbase, Binance, PayPal, Trust Wallet, and Robinhood—all from one secure dashboard.",
  },
  {
    question: "Is Bitcoin supported on your platform?",
    answer:
      "Absolutely. We support Bitcoin (BTC) through various crypto-friendly cards like Binance, Coinbase, and more. You can use your BTC for spending, transfers, and real-time conversions.",
  },
  {
  ...
  },
  {
    question: "Can I build or repair my credit with Ease Withdraw?",
    answer:
      "Yes. While Bitcoin (BTC) is fully supported, many of our partner cards—like Coinbase and Binance—also support other major cryptocurrencies like Ethereum (ETH), USDT, and more",
  },
];
...
const FAQ = () => {
  ...
  return (
    <section className="h-auto mt-16 px-6 md:px-20 py-16 bg-white">
      <motion.h2
        ref={headingRef}
