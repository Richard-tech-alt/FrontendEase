...
//   return (
//     <div className="w-full bg-white py-10    h-auto sm:mt-0 overflow-hidden">
...
//           style={{
//             animation: 'steppedMarquee 20s steps(4) infinite',
//           }}
//         >
...
// Import images directly 
import partner1 from "../../assets/images/Coinbase_Wordmark-719a982e55e945fc93a3b1770b6a9aa9.png";
import partner2 from "../../assets/images/1706268315cash-app-logo-black.png";
import partner3 from "../../assets/images/partner3.png";
import partner4 from "../../assets/images/paypal-featured-image.webp";
import partner5 from "../../assets/images/Robinhood.jpg";
import partner6 from "../../assets/images/Trust_Wallet_logo-aa471e18a7844e38b608a3e8da560fe3.png";
...
const BusinessPartners = () => {
  return (
    <div className="w-full bg-white py-10 h-auto sm:mt-0 overflow-hidden">
      ...
      {/* Marquee */}
      <div className="relative overflow-hidden mx-auto max-w-7xl w-full">
        <div
