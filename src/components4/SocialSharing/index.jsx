...
export default function CryptoSocialComponent() {
  ...
  return (
    <div
      ref={componentRef}
      className="relative w-full h-auto overflow-hidden bg-black/50 mb-12"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto pt-16 md:pt-24 lg:pt-32 px-4 pb-24">
        ...
        >
          {/* Left large image */}
          <div
            className="w-full md:w-40 lg:w-80  md:h-68 lg:h-80   transition-all duration-700 ease-out transform"
            style={{
              opacity: isVisible ? 1 : 0,
          ...
          <div className="flex flex-col gap-4 md:gap-6 w-full md:w-auto">
            ...
            <div
              className="w-full h-44 md:h-50 transition-all duration-700 ease-out transform"
              style={{
                opacity: isVisible ? 1 : 0,
                transform: isVisible ? "translateY(0)" : "translateY(40px)",
      ...
      <div
        className="absolute left-1/2 md:left-5/9 lg:1/2 transform -translate-x-1/2 transition-all duration-500 ease-out"
        style={{
