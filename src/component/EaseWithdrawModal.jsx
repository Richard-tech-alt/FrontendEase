...
const EaseWithdrawModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div 
      ...
      style={{ zIndex: 99999 }}
    >
      <div className="bg-gradient-to-br from-pink-500 to-pink-600 rounded-3xl w-full max-w-md mx-auto relative overflow-visible shadow-2xl transform animate-slideUp">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-2 right-2 text-white hover:bg-white hover:bg-opacity-20 rounded-full p-2 transition-all duration-200 z-10 group"
